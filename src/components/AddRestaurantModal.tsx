...
export const AddRestaurantModal: React.FC = () => {
  ...
  // Handle-only drag: this sheet's own multi-page flow includes a
  // pointer-tracked photo reorder, which would fight a drag-anywhere sheet.
  const { dragProps, startDrag } = useBottomSheet(addRestaurantModalOpen, closeAddRestaurantModal);

...
// Same-origin on web (Vercel serves SPA + function from one domain);
// absolute Vercel URL on native, where the app is served locally.
const FUNCTION_URL = apiUrl('/api/location-chat');

...
const entries: GuideEntry[] = [
 { id: '1', refId: '1', name: 'COTE Flatiron', subtitle: 'Korean · $$$$ · Flatiron', image: '/images/onboarding/contemporary-dining.jpg', score: 9.5, notes: 'A lively room, beautifully considered dishes, and the kind of dinner you keep talking about on the way home. Come with a few friends, take your time, and let the table share a little of everything.', mustOrder: ['Butcher’s Feast', 'Seasonal vegetables'], insiderTip: 'Book an early table for a quieter evening.' },

...
function Preview() {
 const [open,setOpen]=useState(true), [index,setIndex]=useState(1), [dark,setDark]=useState(false);
 ...
 <RestaurantPhotoStage name="A seat at the table" photos={photos} communityPhotos={[{id:'preview-photo',url:photos[1],rawUrl:photos[1],caption:'Miso-glazed salmon',user_id:'preview'} as any]} index={index} onIndexChange={setIndex} open={open} onOpenChange={setOpen} onRecreate={()=>{}}>
